package com.example.myapplication.bottomsheetv2;
...
import com.xq.nestedbehaviordemo.NestedRecycleView;

import java.util.Collections;

public class BottomV2Activity extends AppCompatActivity {
    private SNBBottomSheetBehavior<View> behavior;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bs_v2);
